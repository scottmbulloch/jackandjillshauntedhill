...
require($_SERVER['DOCUMENT_ROOT'].'/ratings/_config-rating.php'); // get the db connection info
...
$new_back[] .= '</ul>';
$new_back[] .= '<small class="caption">Rating: <strong>'.@number_format($sum/$added,1).'</strong>/'.$units.' ('.$count.' '.$tense.' cast)<br /><span class="thanks">Thanks for voting!</span></small>';
