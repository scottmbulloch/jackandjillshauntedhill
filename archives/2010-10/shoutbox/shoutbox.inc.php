...
<table border="0" cellspacing="0" cellpadding="2" width="<? echo $boxWidth; ?>" >
  ...
  <tr>
    <td colspan="4" valign="top"><iframe name="ShoutBox" src="<? echo $boxFolder; ?>shout.php" class="cssShoutBox" width="100%" height="<? echo $boxHeight; ?>" frameborder="0"></iframe></td>
  </tr>
  <tr>
    <td class="cssShoutText" style="width:250px;text-align:right;font-weight:bold;">Name:</td>
    <td colspan="3" style="width:350px;text-align:right;"><input type="text" name="sbName" maxlength="20" class="cssShoutForm" style="width:350px" /></td>
  </tr>
  <tr>
    <td class="cssShoutText" style="text-align:right;font-weight:bold;">Email:</td>
    <td colspan="3" style="text-align:right;"><input type="text" name="sbEMail" maxlength="75" class="cssShoutForm" style="width:350px" /></td>
  </tr>
  <tr>
    <td class="cssShoutText" style="vertical-align:top;text-align:right;font-weight:bold;">Message:</td>
    <td colspan="3" style="text-align:right;"><textarea name="sbText" rows="4" cols="41" class="cssShoutForm"></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><input type="button" name="Refresh" value="<? echo $msg['refresh']; ?>" class="cssShoutButton" onClick="this.disabled=true; refreshBox()" /></td>
    <!--<td><input type="button" name="Admin" value="<? echo $msg['admin']; ?>" class="cssShoutButton" onClick="this.disabled=true; login()"></td>-->
    <td><input type="button" value="<? echo $msg['smilies']; ?>" class="cssShoutButton" onClick="newWindow('<? echo $boxFolder; ?>smilies.php', 130, 300, 0, 0, 1)" /></td>
    <td><input type="button" name="Shout" value="<? echo $msg['shout']; ?>" class="cssShoutButton" onClick="this.disabled=true; shoutIt()" /></td>
  </tr>
</form>
</table>
